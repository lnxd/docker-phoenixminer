...
POOL=Ethermine
printf "%-30s | %-30s | %-30s | %-30s" "${POOL}" "${ER1%?}" "${EC1}" "${EA1}"
printf "%-30s | %-30s | %-30s | %-30s" "${POOL}" "${ER2%?}" "${EC2}" "${EA2}"
printf "%-30s | %-30s | %-30s | %-30s" "${POOL}" "${ER3%?}" "${EC3}" "${EA3}"
printf "%-30s | %-30s | %-30s | %-30s" "${POOL}" "${ER4%?}" "${EC4}" "${EA4}"
POOL=Nanopool
printf "%-30s | %-30s | %-30s | %-30s" "${POOL}" "${NR1%?}" "${NC1}" "${NA1}"
printf "%-30s | %-30s | %-30s | %-30s" "${POOL}" "${NR2%?}" "${NC2}" "${NA2}"
printf "%-30s | %-30s | %-30s | %-30s" "${POOL}" "${NR3%?}" "${NC3}" "${NA3}"
printf "%-30s | %-30s | %-30s | %-30s" "${POOL}" "${NR4%?}" "${NC4}" "${NA4}"
printf "%-30s | %-30s | %-30s | %-30s" "${POOL}" "${NR5%?}" "${NC5}" "${NA5}"
printf "%-30s | %-30s | %-30s | %-30s" "${POOL}" "${NR6%?}" "${NC6}" "${NA6}"
printf "%-30s | %-30s | %-30s | %-30s" "${POOL}" "${NR7%?}" "${NC7}" "${NA7}"
