...
EC1=$(curl -s http://ip-api.com/json/${EI1}?fields=country | jq '.country')
EC2=$(curl -s http://ip-api.com/json/${EI2}?fields=country | jq '.country')
EC3=$(curl -s http://ip-api.com/json/${EI3}?fields=country | jq '.country')
EC4=$(curl -s http://ip-api.com/json/${EI4}?fields=country | jq '.country')
NC1=$(curl -s http://ip-api.com/json/${NI1}?fields=country | jq '.country')
NC2=$(curl -s http://ip-api.com/json/${NI2}?fields=country | jq '.country')
NC3=$(curl -s http://ip-api.com/json/${NI3}?fields=country | jq '.country')
NC4=$(curl -s http://ip-api.com/json/${NI4}?fields=country | jq '.country')
NC5=$(curl -s http://ip-api.com/json/${NI5}?fields=country | jq '.country')
NC6=$(curl -s http://ip-api.com/json/${NI6}?fields=country | jq '.country')
NC7=$(curl -s http://ip-api.com/json/${NI7}?fields=country | jq '.country')
