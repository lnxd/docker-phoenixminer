...
TI1=$(timeout ${TIMEOUT} ./stratum-ping -c 1 ${TA1}:4444 | grep PING | sed -e "s/).*//" | sed -e "s/.*(//")
TI2=$(timeout ${TIMEOUT} ./stratum-ping -c 1 ${TA2}:4444 | grep PING | sed -e "s/).*//" | sed -e "s/.*(//")
TI3=$(timeout ${TIMEOUT} ./stratum-ping -c 1 ${TA3}:4444 | grep PING | sed -e "s/).*//" | sed -e "s/.*(//")
...
ER1=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${EA1}:4444 | tail -1 | awk '{print $4}')
ER2=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${EA2}:4444 | tail -1 | awk '{print $4}')
ER3=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${EA3}:4444 | tail -1 | awk '{print $4}')
ER4=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${EA4}:4444 | tail -1 | awk '{print $4}')
NR1=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${NA1}:9999 | tail -1 | awk '{print $4}')
NR2=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${NA2}:9999 | tail -1 | awk '{print $4}')
NR3=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${NA3}:9999 | tail -1 | awk '{print $4}')
NR4=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${NA4}:9999 | tail -1 | awk '{print $4}')
NR5=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${NA5}:9999 | tail -1 | awk '{print $4}')
NR6=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${NA6}:9999 | tail -1 | awk '{print $4}')
NR7=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${NA7}:9999 | tail -1 | awk '{print $4}')
TR1=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${TA1}:2020 | tail -1 | awk '{print $4}')
TR2=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${TA2}:2020 | tail -1 | awk '{print $4}')
TR3=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${TA3}:2020 | tail -1 | awk '{print $4}')
FR1=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${FA1}:9999 | tail -1 | awk '{print $4}')
FR2=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${FA2}:9999 | tail -1 | awk '{print $4}')
FR3=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${FA3}:9999 | tail -1 | awk '{print $4}')
FR4=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${FA4}:9999 | tail -1 | awk '{print $4}')
FR5=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${FA5}:9999 | tail -1 | awk '{print $4}')
FR6=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${FA6}:9999 | tail -1 | awk '{print $4}')
FR7=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${FA7}:9999 | tail -1 | awk '{print $4}')
HR1=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${HA1}:3939 | tail -1 | awk '{print $4}')
