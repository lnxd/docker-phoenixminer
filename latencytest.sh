...
FR1=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${FA1}:4444 | tail -1 | awk '{print $4}')
FR2=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${FA2}:4444 | tail -1 | awk '{print $4}')
FR3=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${FA3}:4444 | tail -1 | awk '{print $4}')
FR4=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${FA4}:4444 | tail -1 | awk '{print $4}')
FR5=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${FA5}:4444 | tail -1 | awk '{print $4}')
FR6=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${FA6}:4444 | tail -1 | awk '{print $4}')
FR7=$(timeout ${TIMEOUT} ./stratum-ping -c ${COUNT} ${FA7}:4444 | tail -1 | awk '{print $4}')
